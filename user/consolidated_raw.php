...
// Filters (fs_reports.fs_raw_data_summary)
$mainzone = '';
$selected_regions = [];
$selected_areas = [];
$zone = $_GET['zone'] ?? '';
...
$regions_in_zone = [];
if (!empty($zone)) {
    $r_query = "SELECT DISTINCT region FROM fs_reports.fs_raw_data_summary WHERE zone = ? AND region IS NOT NULL AND region != '' ORDER BY region";
...
$tt_query = "SELECT DISTINCT transaction_type FROM fs_reports.fs_raw_data_summary WHERE transaction_type IS NOT NULL AND transaction_type != '' ORDER BY transaction_type";
...
<head>
    ...
    <title>Consolidated Report (from Raw Data)</title>
...
<body>
    <main class="main-content">
        ...
        <div class="content-wrapper">
            <div class="page-title">Consolidated Report (from Raw Data)</div>
            ...
            <form method="GET" class="filter-form" id="filterForm" onsubmit="return validateForm()">
                ...
                <div class="filter-actions">
                    ...
                    <a href="export_consolidated_raw.php?<?= htmlspecialchars(http_build_query($_GET)) ?>" class="btn-export"><i class="fa-solid fa-file-excel"></i> Export Excel</a>
