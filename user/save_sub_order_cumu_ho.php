...
try {
    ...
    // Update each row's sub_order
    $update_stmt = mysqli_prepare($conn, 
        "UPDATE fs_reports.gl_codes_ho
         SET sub_order = ? 
    ...
    foreach ($subOrderMap as $key => $subOrder) {
        ...
        mysqli_stmt_bind_param($update_stmt, 'iss', $subOrder, $desc, $comp);
    ...
    echo json_encode(['ok' => true, 'message' => 'Sub order updated successfully']);
